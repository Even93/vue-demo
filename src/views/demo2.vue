...
// 3. 对于 Vue 中响应式数据原理的说法，下列哪项是不正确的？c    bd
...
// D. 页面首次加载过程中，会依次触发 beforeCreate，created，beforeMount，mounted，beforeUpdate，update

// 作者：doodlewind
// 链接：https://juejin.im/post/6870737289736093710
// 来源：掘金
...
.container-less{
    h3{
        color:@col;
        .border;
        background-color: lighten(spin(@base, 8), 25%); //颜色运算
        // & 代表它的上一层选择器
        &:hover{
             color: red;
        }
